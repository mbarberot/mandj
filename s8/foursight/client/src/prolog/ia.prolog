...
% @param Plateau : l'�tat du plateau de jeu
...
% => Pour chaque pion blanc align� � un pion d'un joueur : on ajoute / supprime 3
eval(Plateau, Joueur, Adv, H):-
...
%
% Predicat permettant de v�rifier si la partie est finie
