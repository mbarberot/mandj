...
\caption{How a webservice work - very simplify !}
\end{center}
\end{figure}
...
\chapter{Conclusion}
As we see, working on a project which was began and continue by a lot of students is not a simple thing. That fact justified the time we spent to analyse and understand the architecture and programming of this software. Thanks to this analysis, we have been able to improved some features (like the search engine) and added new one (communication with the website). 
