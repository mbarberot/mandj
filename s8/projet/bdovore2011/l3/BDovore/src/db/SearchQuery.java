...
public class SearchQuery {
	...
	/* Parametres des fonctions de recherche
	*  searchIn: ALL,OWNED, MISSING
	*  search: chaine � chercher
	*  type: requete count ou requete qui recupere les infos
	*  sortby: colonne selon laquelle on trie
	*  order: desc or asc
	*/
	...
	public static String searchTitre(int searchIn, String search, String type, String sortby, int order) {
		...
		/** TODO : Faire les recherches en fullText */
		// Etoffer pour gerer chaque mot d'une recherche ?
	...
	/** TODO: refaire cette fonction afin de l'adapter � la nouvelle base si n�ccessaire */
