...
public class PanelDBExplorer extends JPanel{
	...
	private JPanel makeSearchPane(){
		...
		// Créer les composants Swing du formulaire de recherche.
		...
		// Créer le formulaire et définir le gestionnaire de postionnement (LayoutManager).
	...
	private void newSearch(){
		...
		//0-Titre, 1-Série, 2-Auteur, 3-ISBN
